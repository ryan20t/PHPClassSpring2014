...
class AddressBook extends DB {
    ...
    */  
    ...
    /**
     * public function to update a database entry
     * @param object $AddressbookModel must be an instanceof AddressbookModel
     * @return boolean
     */
    ...
    /**
     * public function to read a database entry or all depending on argument
     * @param type $id
     * @return array
     */
    ...
    /**
     * public function to get database entry by ID
     * @param type $id
     * @return array
     */
     ...
     /**
      * public function to return all rows in the addressbook table
      * @return array
      */
    ...
    /**
     * public function to remove a database entry
     * @param
     * @return 
     */
